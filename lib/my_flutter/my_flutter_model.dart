...
Widget wrapWithModel<T extends MyFlutterModel>({
  required T model,
...
T createModel<T extends MyFlutterModel>(
...
abstract class MyFlutterModel<W extends Widget> {
...
class MyFlutterDynamicModels<T extends MyFlutterModel> {
  MyFlutterDynamicModels(this.defaultBuilder);
