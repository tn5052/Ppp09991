...
const _kTestStripePublishableKey =
    'pk_test_51OJ6EwIDqA3Zj3EYGEPaOYjoLyJmtoocGguCYGd07n122VMrZ8uDSQUO7nSEBMIvmWVgnbTbnel9VDr6Ur8LemAx00z2A7hodi';
  ...
  try {
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName: 'Saad Stripe',
...
Future<StripePaymentResponse> showWebPaymentSheet(
  ...
  buttonColor = buttonColor ?? MyFlutterTheme.of(context).primary;
