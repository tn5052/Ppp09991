...
import 'meeting_area_model.dart';
export 'meeting_area_model.dart';
...
import 'package:talenties/screens/conference-call/conference_meeting_screen.dart';
import 'package:talenties/utils/api.dart';
import 'package:talenties/widgets/common/joining/join_options.dart';
import '../../constants/colors.dart';
import '../../utils/toast.dart';
import '../../widgets/common/joining/join_view.dart';
import '../../screens/one-to-one/one_to_one_meeting_screen.dart';
...
class MeetingAreaWidget extends StatefulWidget with WidgetsBindingObserver {
  /// Google Meet Web Page
  const MeetingAreaWidget({
    super.key,
  ...
  @override
  State<MeetingAreaWidget> createState() => _MeetingAreaWidgetState();
}

class _MeetingAreaWidgetState extends State<MeetingAreaWidget>
