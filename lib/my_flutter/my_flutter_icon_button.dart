...
class MyFlutterIconButton extends StatefulWidget {
  const MyFlutterIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<MyFlutterIconButton> createState() => _MyFlutterIconButtonState();
}

class _MyFlutterIconButtonState extends State<MyFlutterIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(MyFlutterIconButton oldWidget) {
