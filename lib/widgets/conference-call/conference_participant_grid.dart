...
import 'package:talenties/widgets/conference-call/manage_grid.dart';
import 'package:talenties/widgets/conference-call/participant_grid_tile.dart';
...
class _ConferenceParticipantGridState extends State<ConferenceParticipantGrid> {
  ...
  Widget build(BuildContext context) {
    return Flex(
      direction: isPresenting
          ? Axis.horizontal
          : Axis.vertical, // Fixed direction based on isPresenting
      children: [
  ...
  updateOnScreenParticipants() {
    // Set a fixed device type, for example, device_type.desktop
    device_type fixedDeviceType = device_type.desktop;

    gridInfo = ManageGrid.getGridRowsAndColumns(
      participantsCount: participants.length,
      device: fixedDeviceType, // Use the fixed device type
      isPresenting: isPresenting,
    );
