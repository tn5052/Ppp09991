...
class MyFlutterDropDown<T> extends StatefulWidget {
  const MyFlutterDropDown({
    super.key,
    this.controller,
  ...
  @override
  State<MyFlutterDropDown<T>> createState() => _MyFlutterDropDownState<T>();
}

class _MyFlutterDropDownState<T> extends State<MyFlutterDropDown<T>> {
