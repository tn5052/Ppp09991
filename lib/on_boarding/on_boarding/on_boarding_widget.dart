                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: Text(
                                    ' Web Have Top Mentors from the industry ',
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: Text(
                                    'Modern Events Calendar Feature to meet ',
                                    textAlign: TextAlign.center,
                                    style: MyFlutterTheme.of(context)
                                        .headlineMedium
                                        .override(
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: Text(
                                    '  To Look Up Events or Activities Using Map',
                                    textAlign: TextAlign.center,
                                    style: MyFlutterTheme.of(context)
                                        .headlineMedium
                                        .override(
                ...
                child: Padding(
                  ...
                  child: smooth_page_indicator.SmoothPageIndicator(
                    ...
                    effect: smooth_page_indicator.ExpandingDotsEffect(
                      ...
                      dotWidth: 16.0,
                      dotHeight: 4.0,
                      dotColor: MyFlutterTheme.of(context).accent4,
                      activeDotColor:
