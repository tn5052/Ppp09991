...
import '/my_flutter/my_flutter_util.dart' show routeObserver;
...
class MyFlutterVideoPlayer extends StatefulWidget {
  const MyFlutterVideoPlayer({
    super.key,
    required this.path,
  ...
  @override
  State<StatefulWidget> createState() => _MyFlutterVideoPlayerState();
}

class _MyFlutterVideoPlayerState extends State<MyFlutterVideoPlayer>
    with RouteAware {
  ...
  @override
  void didUpdateWidget(MyFlutterVideoPlayer oldWidget) {
