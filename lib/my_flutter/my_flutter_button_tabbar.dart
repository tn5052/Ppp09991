...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _MyFlutterButtonTabBarState tabBar;
...
/// A MyFlutter Design widget that displays a horizontal row of tabs.
class MyFlutterButtonTabBar extends StatefulWidget
  ...
  /// and the entire [MyFlutterButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<MyFlutterButtonTabBar> createState() => _MyFlutterButtonTabBarState();
}

class _MyFlutterButtonTabBarState extends State<MyFlutterButtonTabBar>
  ...
  @override
  void didUpdateWidget(MyFlutterButtonTabBar oldWidget) {
