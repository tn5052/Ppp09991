...
class MyFlutterMarker {
  const MyFlutterMarker(this.markerId, this.location, [this.onTap]);
  final String markerId;
  final latlng.LatLng location;
  final Future Function()? onTap;
}

class MyFlutterGoogleMap extends StatefulWidget {
  const MyFlutterGoogleMap({
  ...
  final Iterable<MyFlutterMarker> markers;
  ...
  @override
  State<StatefulWidget> createState() => _MyFlutterGoogleMapState();
}

class _MyFlutterGoogleMapState extends State<MyFlutterGoogleMap> {
  ...
  @override
  void didUpdateWidget(MyFlutterGoogleMap oldWidget) {
