...
import 'package:talenties/screens/common/join_screen.dart';
import 'package:talenties/utils/toast.dart';
import 'package:talenties/widgets/common/app_bar/meeting_appbar.dart';
import 'package:talenties/widgets/common/app_bar/web_meeting_appbar.dart';
import 'package:talenties/widgets/common/chat/chat_view.dart';
import 'package:talenties/widgets/common/joining/waiting_to_join.dart';
import 'package:talenties/widgets/common/meeting_controls/meeting_action_bar.dart';
import 'package:talenties/widgets/common/participant/participant_list.dart';
import 'package:talenties/widgets/common/screen_share/screen_select_dialog.dart';
import 'package:talenties/widgets/conference-call/conference_participant_grid.dart';
import 'package:talenties/widgets/conference-call/conference_screenshare_view.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Flex(
                            direction: Axis
                                .horizontal, // Set a fixed direction based on layout
                            children: [
  ...
  void registerMeetingEvents(Room _meeting) {
    ...
    _meeting.on(Events.roomLeft, (String? errorMsg) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => JoinScreen(slot15min: widget.slot15min,)),
          (route) => false);
    });
